...
{
    public class PlayerModel : IBroadsignAPIModel
    {
        ...
        //public static ObservableCollection<PlayerModel> GetPlayers(string token, int id = 0)
        //{
        ...
        //    return JsonConvert.DeserializeObject<ObservableCollection<PlayerModel>>(root["host"].ToString());
        //}
